...
atualizarChamadosSoftwareHardware("Driver não instala","Administrativo","Alta","Computador Dell",2);
atualizarChamados("Não ta dando tela","Financeiro","Alta","Notebook Acer",0);

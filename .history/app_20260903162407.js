...
console.log("Atualizando chamado 3 e 1");
    atualizarChamadoSoftware("Explorador de Arquivos deletado","Administrativo","Alta","Computador Dell");
    atualizarChamadoHardware("Não ta dando tela","Financeiro","Alta","Notebook Acer");
listarOsChamados();

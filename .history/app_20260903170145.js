...
atualizarChamadosSoftware("Driver não instala","Administrativo","Alta","Computador Dell",2);
atualizarChamadosHardware("Não ta dando tela","Financeiro","Alta","Notebook Acer",0);
